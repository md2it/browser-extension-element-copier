...
- *START*
   - Содержит тексты "To copy:", "HOVER and CLICK". Эти два текста близко друг к другу по высоте
- *COPIED*
   - Содержит текст "Copied!". Крупный, зелёный, центрованный
   - Содержит текст "Saved to your clipboard". Просто центрованный, обычный
