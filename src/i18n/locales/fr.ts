...
export const FR_MESSAGES: Strings = {
  ...
  settingsComputeImagesInfo:
    "Sur les grandes pages, la génération d'images prend beaucoup de temps. Si vous n'en avez pas besoin, désactivez-les pour aller beaucoup plus vite.",
