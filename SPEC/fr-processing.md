...
> [!NOTE] сейчас PNG и JPEG делаются двумя отдельными последовательными процессами. Это очень долго, дорого, и на выходе разные изображения (так как сделаны в разное время). Ниже целевой процесс. Когда мы полностью обновим процесс, то текущий NOTE нужно убрать
