...
# Project flags: -l lib, -c element-copier, -d element-deleter, -e element-explorer, -g generate-n-decode
...
usage() {
  print -r -- "Usage: ./lib/scripts/cmt.zsh [-l|-c|-d|-e|-g] [--project-name <name>] [--comment <message>]"
  print -r -- "  -l  lib"
